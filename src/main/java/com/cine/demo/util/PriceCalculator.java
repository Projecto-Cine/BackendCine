...
public class PriceCalculator {
    ...
    public static BigDecimal applyFidelityDiscount(BigDecimal adultSubtotal, int visitsPerYear, List<TicketType> types) {
        if (visitsPerYear <= FIDELITY_THRESHOLD) return BigDecimal.ZERO;
