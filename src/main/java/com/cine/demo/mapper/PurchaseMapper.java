...
public class PurchaseMapper {
    ...
    public PurchaseResponseDTO toResponseDto(Purchase purchase) {
        ...
        return PurchaseResponseDTO.builder()
                ...
                .screeningId(purchase.getScreening() != null ? purchase.getScreening().getId() : null)
                .movieTitle(purchase.getScreening() != null ? purchase.getScreening().getMovie().getTitle() : null)
                .theaterName(purchase.getScreening() != null ? purchase.getScreening().getTheater().getName() : null)
                .dateTime(purchase.getScreening() != null ? purchase.getScreening().getDateTime() : null)
                .tickets(ticketDtos)
