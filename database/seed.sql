-- ============================================================
--  Lumen Cinema — Datos completos
--  Ejecutar DESPUÉS de schema.sql:
--    mysql -u root -p < database/schema.sql
--    mysql -u root -p < database/seed.sql
--
--  Contraseña de todos los usuarios: lumen2024
--  Al arrancar la app, DataInitializer cifra las contraseñas con BCrypt.
-- ============================================================
...
VALUES
    ...
    (5, 'Supervisor', 'Lumen',  'supervisor@lumen.com',   'lumen2024', '1990-01-01', 'ADULT',   0, FALSE, 'SUPERVISOR',  NULL, NOW(), NOW()),
    (6, 'Operator',   'Lumen',  'operator@lumen.com',     'lumen2024', '1990-01-01', 'ADULT',   0, FALSE, 'OPERATOR',    NULL, NOW(), NOW()),
    (7, 'Ticketer',   'Lumen',  'ticket@lumen.com',       'lumen2024', '1990-01-01', 'ADULT',   0, FALSE, 'TICKET',      NULL, NOW(), NOW()),
    (8, 'Maintenance','Lumen',  'maintenance@lumen.com',  'lumen2024', '1990-01-01', 'ADULT',   0, FALSE, 'MAINTENANCE', NULL, NOW(), NOW());
...
VALUES
    ...
    (5, 'Dune: Part Two',    'La lucha por Arrakis continua.',                166, 'Ciencia ficcion', '12',  NULL, TRUE, 'ES',      '2D',       NOW()),
    (6, 'Godzilla x Kong',   'Dos titanes unen fuerzas.',                    115, 'Accion',          '16',  NULL, TRUE, 'VO',      '3D',       NOW()),
    (7, 'Kung Fu Panda 4',   'Po busca un nuevo Guerrero Dragon.',             94, 'Animacion',       'ALL', NULL, TRUE, 'ES',      '2D',       NOW()),
    (8, 'Civil War',         'Periodistas en una America distopica.',         109, 'Drama',           '18',  NULL, TRUE, 'VOSE',    '2D',       NOW()),
    (9, 'The First Omen',    'El origen del mal.',                            119, 'Terror',          '18',  NULL, TRUE, 'VO',      '2D',       NOW());
...
VALUES
    (1, 'Carlos Ruiz',      'carlos@lumen.com', 'CAJERO',    NOW()),
    (2, 'Maria Fernandez',  'maria@lumen.com',  'GERENCIA',  NOW()),
    (3, 'Jose Sanchez',     'jose@lumen.com',   'SEGURIDAD', NOW()),
    (4, 'Ana Gomez',        'ana@lumen.com',    'LIMPIEZA',  NOW());
...
-- ============================================================
-- VERIFICACION — cuenta registros por tabla
-- ============================================================
